<template>
    <div x-data="{ cartOpen: false , isOpen: false }" class="bg-white mb-4">
        <header>
            <div class="container mx-auto px-6 py-3">
                ...
                <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                    <div class="flex flex-col sm:flex-row">
                        <router-link class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" to="/">Items
                        </router-link>
                        <router-link class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" to="/shop">Shop cart
                        </router-link>
                        <router-link class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" to="/checkout">Checkout
                        </router-link>
                    </div>
                </nav>
