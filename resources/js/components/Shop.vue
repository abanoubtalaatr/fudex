<template>
    <MyHeader></MyHeader>
    <div class="flex justify-center my-6" v-if="carts.length > 0">
                        ...
                        <div class="p-4">
                            ...
                            <a href="#">
                                <button
                                    ...
                                    <router-link class="mt-3 hover:underline sm:mx-3 sm:mt-0" to="/checkout">
    ...
    <div class="flex justify-center my-6" v-if="carts.length ==0">
        <h3> Your shop is empty go to items</h3>
    </div>
    <Footer></Footer>
</template>
